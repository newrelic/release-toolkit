...
| `disable-github-validation` | `false`          | Disables Github links validation for automatically detected Github repositories. When disabled, changelog links for Github repositories are directly rendered using https://github.com/<org>/<repo>/releases/tag/<new-version> with no validation, so no external request are performed.                                                                                                                                                                                                                                                                                                                                                                                                                                             |
