...
// IsHeld is a command function which loads a changes.yaml file from this, and prints to stdout whether it has the
...
func IsHeld(cCtx *cli.Context) error {
	...
	if err != nil {
		return fmt.Errorf("opening changes.yaml file %q: %w", chPath, err)
	}
