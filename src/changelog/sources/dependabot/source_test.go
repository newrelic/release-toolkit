...
func TestSource_Source(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{
			commit: git.Commit{Message: "Whatever actions/github-script from 1.0.2 to 1.0.4.", Author: "dependabot[bot]"},
		},
		{
			commit: git.Commit{Message: "Non matching", Author: "dependabot[bot]"},
		},
		{
		...
		{
			commit:   git.Commit{Message: "chore(deps): bump common-library-2 from v0.0.3 to v0.0.4", Author: "dependabot[bot]"},
...
Bumps [actions/github-script](https://github.com/actions/github-script) from 4.0.2 to 4.1.`, Author: "dependabot[bot]"},
			expected: []changelog.Dependency{{Name: "actions/github-script", From: semver.MustParse("4.0.2"), To: semver.MustParse("4.1")}},
		},
		{
			commit:   git.Commit{Message: "Bump actions/github-script from 2 to 4.0.2", Author: "dependabot[bot]"},
			expected: []changelog.Dependency{{Name: "actions/github-script", From: semver.MustParse("2"), To: semver.MustParse("4.0.2")}},
		},
		{
			commit:   git.Commit{Message: "chore(deps): bump github.com/spf13/viper from 1.7.0 to 1.10.1", Author: "dependabot[bot]"},
			expected: []changelog.Dependency{{Name: "github.com/spf13/viper", From: semver.MustParse("1.7.0"), To: semver.MustParse("1.10.1")}},
		},
		{
			commit:   git.Commit{Message: "chore(deps): bump github.com/google/go-cmp from 0.5.6 to 0.5.7", Author: "dependabot[bot]"},
			expected: []changelog.Dependency{{Name: "github.com/google/go-cmp", From: semver.MustParse("0.5.6"), To: semver.MustParse("0.5.7")}},
		},
		{
			commit:   git.Commit{Message: "chore(deps): bump alpine from 3.15.4 to 3.16.0", Author: "dependabot[bot]"},
			expected: []changelog.Dependency{{Name: "alpine", From: semver.MustParse("3.15.4"), To: semver.MustParse("3.16.0")}},
		},
		{
			commit:   git.Commit{Message: "chore(deps): bump github.com/newrelic/infra-integrations-sdk from 3.7.1+incompatible to 3.7.2+incompatible", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "chore(deps): bump common-library-3/library from v1.0.3 to v1.2.3", Author: "dependabot[bot]"},
			expected: []changelog.Dependency{{Name: "common-library-3/library", From: semver.MustParse("1.0.3"), To: semver.MustParse("1.2.3")}},
		},
		{
			commit:   git.Commit{Message: "chore(deps): bump common-library-4 from v9.10.30 to v10.20.30", Author: "dependabot[bot]"},
			expected: []changelog.Dependency{{Name: "common-library-4", From: semver.MustParse("9.10.30"), To: semver.MustParse("10.20.30")}},
		},
		{
			commit:   git.Commit{Message: "chore(deps): bump common-library-5 from v1.0.2-prerelease+meta to v1.1.2-prerelease+meta", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "chore(deps): bump common-library-6 from v0.9.2+meta to v1.1.2+meta", Author: "dependabot[bot]"},
			expected: []changelog.Dependency{{Name: "common-library-6", From: semver.MustParse("0.9.2+meta"), To: semver.MustParse("1.1.2+meta")}},
		},
		{
			commit:   git.Commit{Message: "chore(deps): bump common-library-7 from v0.9.2+meta-valid to v1.1.2+meta-valid", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "chore(deps): bump common-library-13 from v0.9.0-alpha-a.b-c-somethinglong+build.1-aef.1-its-okay to v1.0.0-alpha-a.b-c-somethinglong+build.1-aef.1-its-okay", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "chore(deps): bump common-library-14 from v1.6.0-rc.1+build.123 to v2.0.0-rc.1+build.123", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "chore(deps): bump common-library-15 from v1.1.0-SNAPSHOT-123 to v1.2.3-SNAPSHOT-123", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "chore(deps): bump common-library-16 from v1.0.0+build.1848 to v2.0.0+build.1848", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "chore(deps): bump common-library-18 from v0.1.0-alpha+beta to v1.0.0-alpha+beta", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "chore(deps): bump common-library-19 from v1.1.0----RC-SNAPSHOT.12.9.1 to v1.2.3----RC-SNAPSHOT.12.9.1", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "chore(deps): bump common-library-20 from v0.1.0+0.build.1-rc.10000aaa-kk-0.1 to v1.0.0+0.build.1-rc.10000aaa-kk-0.1", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "bump really/weird-library-3 from v1 to v2", Author: "dependabot[bot]"},
			expected: []changelog.Dependency{{Name: "really/weird-library-3", From: semver.MustParse("v1"), To: semver.MustParse("v2")}},
		},
		{
			commit:   git.Commit{Message: "bump unknown-from to v2 (#123)", Author: "dependabot[bot]"},
			expected: []changelog.Dependency{{Name: "unknown-from", To: semver.MustParse("v2"), Meta: changelog.EntryMeta{PR: "123"}}},
		},
		{
			commit:   git.Commit{Message: "bump unknown-to from v1 (#123)", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "Bump github.com/golangci/golangci-lint from 1.40.0 to 1.42.1 (#144)", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "Bump github.com/Shopify/sarama from 1.30.1 to 1.31.0 (#152)", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "Bump github.com/newrelic/infra-integrations-sdk (#150)", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "build(deps): bump aquasecurity/trivy-action from 0.0.18 to 0.0.19 (#181)", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "build(deps): bump actions/github-script (#193)", Author: "dependabot[bot]"},
			expected: []changelog.Dependency{{Name: "actions/github-script", Meta: changelog.EntryMeta{PR: "193"}}},
		},
		{
			commit:   git.Commit{Message: "build(deps): bump github.com/newrelic/infra-integrations-sdk from 3.6.8+incompatible to 3.7.0+incompatible (#236)", Author: "dependabot[bot]"},
		...
		{
			commit:   git.Commit{Message: "build(deps): bump github.com/urfave/cli/v2 from 2.14.0 to 2.14.1 in /src (#65)", Author: "dependabot[bot]"},
		...
		Bumps [actions/github-script](https://github.com/actions/github-script) from 4.0.2 to 4.1.`, Hash: "abcda222", Author: "dependabot[bot]"},
			expected: []changelog.Dependency{{
		...
		{
			commit: git.Commit{Message: "Bump actions/github-script from 2 to 4.0.2 (#116)", Hash: "abcda222", Author: "dependabot[bot]"},
			expected: []changelog.Dependency{{
				Name: "actions/github-script",
		...
		{
			commit: git.Commit{Message: "chore(deps): bump github.com/spf13/viper from 1.7.0 to 1.10.1", Hash: "abcda222", Author: "dependabot[bot]"},
			expected: []changelog.Dependency{{
