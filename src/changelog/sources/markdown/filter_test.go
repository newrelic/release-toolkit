...
func (mr *mockRenderer) RenderNode(_ io.Writer, node ast.Node, entering bool) ast.WalkStatus {
	mr.called++
	return ast.GoToNext
}
func (mr *mockRenderer) RenderHeader(_ io.Writer, ast ast.Node) {}
func (mr *mockRenderer) RenderFooter(_ io.Writer, ast ast.Node) {}
